...
from colorama import Fore as FontColour
import requests
import urllib3
import json
...
SERVER = "https://213.86.71.1:4431"
USER = "admin"
PASSWORD = "Q8e3JhFHtuQ&"


def main():
    print(FontColour.YELLOW + "~" * 50)
    print(FontColour.RED + "|" + " " * 48 + "|")
    print("|" + FontColour.CYAN + "      MATT'S AWESOME DNAC API CALLER THINGY     " + FontColour.RED + "|")
    print(FontColour.RED + "|" + " " * 48 + "|")
    print(FontColour.YELLOW + "~" * 50)
...
def get_devices(auth_token, get_all_devices=True):
    ...
    num_of_devices = len(devices['response'])
